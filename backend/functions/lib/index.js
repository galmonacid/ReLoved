...
exports.upsertItemConversation = functions.https.onCall(async (data, context) => {
...
exports.closeConversationByDonor = functions.https.onCall(async (data, context) => {
    const uid = requireAuth(context);
    const payload = isObject(data) ? data : {};
    const conversationId = requireNonEmptyString(payload.conversationId, "conversationId", 1, 256);
    const conversationRef = db.collection("conversations").doc(conversationId);
...
exports.reopenConversationByDonor = functions.https.onCall(async (data, context) => {
    const uid = requireAuth(context);
    const payload = isObject(data) ? data : {};
    const conversationId = requireNonEmptyString(payload.conversationId, "conversationId", 1, 256);
    const conversationRef = db.collection("conversations").doc(conversationId);
...
exports.blockConversationParticipant = functions.https.onCall(async (data, context) => {
    const uid = requireAuth(context);
    const payload = isObject(data) ? data : {};
    const conversationId = requireNonEmptyString(payload.conversationId, "conversationId", 1, 256);
...
exports.reportConversation = functions.https.onCall(async (data, context) => {
    const uid = requireAuth(context);
    const payload = isObject(data) ? data : {};
    const conversationId = requireNonEmptyString(payload.conversationId, "conversationId", 1, 256);
...
exports.setItemContactPreference = functions.https.onCall(async (data, context) => {
    const uid = requireAuth(context);
    const payload = isObject(data) ? data : {};
    const itemId = requireNonEmptyString(payload.itemId, "itemId", 1, 128);
