...
(cuentas, publicaciones y mensajes de contacto). No vendemos datos personales.
...
- Contacto entre usuarios sobre un item.
- Mejora del producto (analitica agregada).

## Comparticion de datos
- Se comparte el email del remitente con el propietario del item al enviar un
  mensaje de contacto.
